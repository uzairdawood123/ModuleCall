...
import com.vdotok.streaming.R
import kotlinx.android.synthetic.main.video_perview.view.*
import org.webrtc.EglBase
import org.webrtc.SurfaceViewRenderer


class CallViewRenderer(context: Context, attrs: AttributeSet) :
    ...
    private var preview: SurfaceViewRenderer
    private var borderView: View
    var proxyVideoSink: ProxyVideoSink
    private val rootEglBase = EglBase.create()

    init {
        inflate(context, R.layout.video_perview, this)
...
//        show hide border for the view
    ...
    fun swapViews(activity: Activity, remoteView: CallViewRenderer, ownView: CallViewRenderer) {
